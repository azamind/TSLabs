...
{
    public class ParabolicTakeStopBreakevenAbsCloseReverseStrategyScript : IExternalScript
    {
            ...
            for (int i = 0; i < barsCount; i++)
            {
                ...
                else
                {
                    if (openLong.EntryBarNum <= i)
                    {
                        ...
                        {
                            openLong.CloseAtStop(i + 1, entryPriceLong + breakevenCached[i], CloseLongBreakeven);
                        }
                        else
                        {
                ...
                else
                {
                    if (openShort.EntryBarNum <= i)
                    {
                        ...
                        {
                            openShort.CloseAtStop(i + 1, entryPriceShort - breakevenCached[i], CloseShortBreakeven);
                        }
                        else
                        {
